...
## Figure 2: Power to detect rare cell types

## Figure 3: Gene curve fits using our gamma mixed models parameterized over UMI counts per cell

## Figure 4: Expression probability, power and detection power
...
########
# DE subplot
cellsPerCelltype<-c(50,100,150,200,300)
...
res<-lapply(1:nrow(param.combis),function(i)
  power.general.withDoublets(param.combis$sampleSize[i],
                             ...
                             personsPerLane,read.umi.fit,gamma.mixed.fits,ct,
...
## Figure 5: Optimized parameter to maximize detection power
...
power.study<-optimize.constant.budget(totalBudget,readDepth,cellsPerPerson,costKit,
                              ...
                              read.umi.fit,gamma.mixed.fits,ct,disp.fun.param,
