...
power<-power.general.withDoublets(nSamples=100,nCells=1500,readDepth=25000,
                                  ...
                                  gamma.probs = scPower::gamma.probs,
                                  ct="CD14+ Monocytes",
...
power<-power.smartseq(nSamples=100,nCells=1500,readDepth=25000,
                      ...
                      gamma.probs = scPower::gamma.probs.smart,
                      ct="alpha",
...
Instead of the sample size, the flexible parameter can also be the number of cells per individual or the read depth. We set here the sample size to values between 50 and 300 and leave each of the other two parameters out.
